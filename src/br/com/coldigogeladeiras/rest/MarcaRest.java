...
public class MarcaRest extends UtilRest{
	...
	public Response inserir(String marcaParam) {
		try {
			...
			JDBCMarcaDAO jdbcMarca = new JDBCMarcaDAO(conexao);
			boolean marcaExistente = jdbcMarca.verificaNome(marca.getNome());
	...
	public Response excluir(@PathParam("id") int id) {
		try {
			...
			Connection conexao = conec.abrirConexao();
			JDBCMarcaDAO jdbcMarca = new JDBCMarcaDAO(conexao);
			boolean verificaProduto = jdbcMarca.verificaProduto(id);
			...
			if (!verificaProduto) {
				...
				msg = "Impossível deletar, pois existem produtos com esta marca";
			}
	...
	public Response alterarStatus(String marcaParam) {
		try {
			...
			boolean retorno = jdbcMarca.alterarStatus(marca);
			String msg = "";
			if (retorno) {
				msg = "Marca alterada com sucesso";
			} else {
