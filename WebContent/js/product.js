...
$(document).ready(function(){	
	...
	COLDIGO.produto.cadastrar = function(){
		...
		produto.capacidade = document.frmAddProduto.valor.value;
		...
		if (listaDeProdutos != undefined && listaDeProdutos.length > 0){
			...
			for (var i=0; i<listaDeProdutos.length; i++){
				...
				"<td>"+
					...
					"<a onclick=\"COLDIGO.produto.excluir('"+listaDeProdutos[i].id+"')\"><img src='../../imgs/delete.png' alt='Editar registro'> </a>"+
				"</td>"+
				"</tr>";
			}
